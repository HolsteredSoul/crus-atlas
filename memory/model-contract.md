...
metadata:
  type: project
---
The atlas now loads a 74-part Z-Anatomy Draco GLB by default. Preserve its CC BY-SA attribution and source tissue vertex colours. The user rejected primitive anatomy; no primitive fallback remains.
